...
buttons.addEventListener('click', function(event) {
    if((!event.target.classList.contains('key_digit'))&(!event.target.classList.contains('key_operation'))&(!event.target.classList.contains('key_bracket'))&(!event.target.classList.contains('key_result'))&(!event.target.classList.contains('key_clear'))) return;
